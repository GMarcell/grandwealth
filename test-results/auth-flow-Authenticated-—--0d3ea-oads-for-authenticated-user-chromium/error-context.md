...
- Name: auth-flow.spec.ts >> Authenticated — Dashboard access >> dashboard loads for authenticated user
- Location: e2e/tests/auth-flow.spec.ts:165:7
...
Error: strict mode violation: getByText('Dashboard') resolved to 2 elements:
    1) <span class="flex-1">Dashboard</span> aka getByRole('link', { name: 'Dashboard' })
    2) <h1 class="text-2xl font-bold tracking-tight">Dashboard</h1> aka getByRole('heading', { name: 'Dashboard' })
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e87]:
      - generic [ref=e91]:
        ...
        - paragraph [ref=e93]: Your complete wealth overview
