...
- Name: auth-flow.spec.ts >> Authenticated — Dashboard access >> transactions page loads for authenticated user
- Location: e2e/tests/auth-flow.spec.ts:175:7
...
Locator: getByText('Transactions')
Expected: visible
Error: strict mode violation: getByText('Transactions') resolved to 2 elements:
    1) <span class="flex-1">Transactions</span> aka getByRole('link', { name: 'Transactions' })
    2) <h1 class="text-2xl font-bold tracking-tight">Transactions</h1> aka getByRole('heading', { name: 'Transactions' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Transactions')
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e87]:
      - generic [ref=e89]:
        - generic [ref=e90]:
          - generic [ref=e91]:
            - heading "Transactions" [level=1] [ref=e92]
            - paragraph [ref=e93]: Track your income and expenses
          - generic [ref=e94]:
            - button "Import" [ref=e96]:
              - img
              - text: Import
            - button "Export" [ref=e97]:
              - img
              - text: Export
          - button "Add Transaction" [ref=e98]:
            - img
            - text: Add Transaction
        - generic [ref=e99]:
          - generic [ref=e100]:
            - generic [ref=e101]:
              - heading "Total Income" [level=2] [ref=e102]
              - img [ref=e103]
            - generic [ref=e107]: Rp 0
          - generic [ref=e108]:
            - generic [ref=e109]:
              - heading "Total Expenses" [level=2] [ref=e110]
              - img [ref=e111]
            - generic [ref=e115]: Rp 0
          - generic [ref=e116]:
            - heading "Net Cash Flow" [level=2] [ref=e118]
            - generic [ref=e120]: Rp 0
        - generic [ref=e121]:
          - generic [ref=e122]:
            - img [ref=e123]
            - textbox "Search transactions..." [ref=e126]
          - combobox [ref=e127]:
            - img [ref=e128]
            - img [ref=e130]
          - combobox [ref=e132]
