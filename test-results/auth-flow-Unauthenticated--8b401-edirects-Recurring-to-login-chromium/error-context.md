...
- Name: auth-flow.spec.ts >> Unauthenticated — Auth Flow >> Protected routes redirect >> redirects Recurring to /login
...
waiting for navigation until "load"
  navigated to "http://localhost:3000/recurring"
============================================================
```
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e88]:
      - generic [ref=e90]:
        - generic [ref=e91]:
          - generic [ref=e92]:
            - heading "Recurring Transactions" [level=1] [ref=e93]
            - paragraph [ref=e94]: Set up automatic transactions that repeat on a schedule
          - button "Add Recurring" [ref=e95]:
            - img
            - text: Add Recurring
        - generic [ref=e96]:
          - heading "Recurring Schedules (0 total)" [level=2] [ref=e98]:
            - img [ref=e99]
            - text: Recurring Schedules
            - generic [ref=e104]: (0 total)
          - generic [ref=e106]:
            - img [ref=e107]
            - paragraph [ref=e112]: No recurring transactions yet.
            - paragraph [ref=e113]: Set up recurring income (salary, freelance) or expenses (rent, subscriptions) that happen on a schedule.
