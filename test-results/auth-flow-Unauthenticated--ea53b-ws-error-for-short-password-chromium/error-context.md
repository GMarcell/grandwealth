...
- Name: auth-flow.spec.ts >> Unauthenticated — Auth Flow >> Registration >> shows error for short password
- Location: e2e/tests/auth-flow.spec.ts:32:9
...
- text: Start tracking your wealth journey Name
- textbox "Name":
