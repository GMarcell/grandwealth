...
- Name: combobox-clear.spec.ts >> Stocks Page — Combobox Clear Button >> clear button does not open the popover on stocks page
- Location: e2e/tests/combobox-clear.spec.ts:118:7
...
Call log:
  - waiting for getByRole('combobox', { name: 'Search stock symbol...' })
      ...
      - generic:
        - generic:
          ...
          - generic:
            - generic:
              ...
              - button [disabled]:
                ...
                - text: Add Dividend
            - generic:
              - paragraph: No dividends recorded yet. Add stocks first to record dividend payouts.
          - generic:
            - generic:
              - img
              - textbox:
          ...
          - generic:
            - generic:
              - generic:
                - paragraph: No stocks yet. Add your first stock!
